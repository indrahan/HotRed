...
{
    public partial class InitialCreateProject5_6 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPhoneNo = table.Column<int>(type: "int4", nullable: false),
                    UserSurname = table.Column<string>(type: "text", nullable: true),
                    UserZipcode = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
