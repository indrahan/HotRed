...
namespace project5_6.Controllers
{
    public class AllProductController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            var webContext = _context.Product.Include(p => p.SubCategory);
            var webContext2 = _context.Product.Where(p => p.ProductBrand.Contains(searchString));
            ViewBag.Product = (from x in _context.Product
